...
use Gertvdb\Types\DateTime\Formats\MinuteFormat;
...
final readonly class Minute implements IInt
{
    ...
    public function format(MinuteFormat $format): StringValue
    {
        return match ($format) {
            MinuteFormat::NUMERIC => StringValue::fromInt($this->toInt()),
            MinuteFormat::TWO_DIGIT => StringValue::fromInt($this->toInt())->padLeft(2, '0'),
        };
    }
