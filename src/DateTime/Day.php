...
final readonly class Day implements IInt
{
    ...
    public function format(DayFormat $format): StringValue
    {
        return match ($format) {
            DayFormat::NUMERIC => StringValue::fromInt($this->toInt()),
            DayFormat::TWO_DIGIT => StringValue::fromInt($this->toInt())->padLeft(2, '0'),
        };
    }
